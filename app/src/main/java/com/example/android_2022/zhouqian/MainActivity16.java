        ...
        button_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(account)){
                    Toast.makeText(MainActivity16.this,"请输入帐号",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(password)){
                    Toast.makeText(MainActivity16.this,"请输入密码",Toast.LENGTH_SHORT).show();
                    return;
                }
                Toast.makeText(MainActivity16.this,"登录成功",Toast.LENGTH_SHORT).show();
                boolean isSuccess = FileSave.saveUserInfo(MainActivity16.this,account,password);

                if(isSuccess){
                    AlertDialog.Builder builder=new AlertDialog.Builder(MainActivity16.this);
